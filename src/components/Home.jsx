...
const Home = () => {
  return (
    <div className='container main pt-2 align-items-center justify-content-center d-flex flex-column'>
      ...
      <div className="home-img text-center col-lg-4 mt-4 col-sm-1 px-sm-2">
        <img src="/home-img.png" alt=""/>
      </div>
      <div className="home-footer d-flex align-items-center justify-content-center text-center mt-5 mx-5">
